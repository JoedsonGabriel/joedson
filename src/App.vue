...
<style lang="scss">
  @font-face {
    ...
    src: url('assets/fonts/Starjedi.woff') format('woff'), /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
      url('assets/fonts/Starjedi.ttf') format('truetype'); /* Chrome 4+, Firefox 3.5, Opera 10+, Safari 3—5 */
  }  
  /* Config */
  $color-bg: #1e1e1e;
  $color-particle: #fff;
